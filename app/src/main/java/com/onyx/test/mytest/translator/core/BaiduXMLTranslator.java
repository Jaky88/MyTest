package com.onyx.test.mytest.translator.core;

import com.alibaba.fastjson.JSON;
import com.onyx.test.mytest.translator.config.Constants;
import com.onyx.test.mytest.translator.config.Language;
import com.onyx.test.mytest.translator.entity.BaiduParams;
import com.onyx.test.mytest.translator.entity.BaiduTranslateResult;
import com.onyx.test.mytest.translator.entity.Params;
import com.onyx.test.mytest.translator.network.RetrofitWrapper;
import com.onyx.test.mytest.translator.network.TranslateService;
import com.onyx.test.mytest.translator.utils.MD5Utils;
