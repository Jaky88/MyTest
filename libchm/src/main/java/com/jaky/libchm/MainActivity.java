...
import com.jaky.libchm.lib.Utils;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chmFilePath = revIntent.getStringExtra("fileName");
        Utils.chm = null;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (i == R.id.menu_sitemap) {
            webview.loadUrl("file://" + extractPath + "/" + listSite.get(0));

        } else if (i == R.id.menu_back_page) {
        ...
        } else if (i == R.id.menu_zoom_in) {
            webview.setInitialScale(300);

        } else if (i == R.id.menu_zoom_out) {
        ...
        } else if (i == R.id.menu_search_all) {
    ...
    private void initFile() {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                extractPath = MainActivity.this.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS) + "/CHMReader/" + md5File;
